...
public class Ejercicio_1 {
    ...
    public static void main(String[] args) {
        ...
        do{
            ...
            switch(menu){
                case 1: {
                    if (contadorJugadores >= numeroJugadores) {
                        System.out.println("El equipo ya está completo. No puedes capturar más jugadores.");
                    } else {
                        while(contadorJugadores<numeroJugadores){
                            ...
                            // Verificamos si aún hay espacio antes de preguntar si quiere capturar otro
                            if (contadorJugadores < numeroJugadores) {
                                System.out.println("¿Desea capturar otro jugador? (s/n) ");
                                continuar = sn.nextLine(); // Aquí se corrigió la asignación
                                if (continuar.equalsIgnoreCase("n")) {
                                    break;
                                }
                            } else {
                                System.out.println("¡Equipo completo! Has alcanzado el límite de jugadores.");
                            }
                        }//while
                    }//else
                    break;
